...
```shell
DIGITIZED_THESES_S3_BUCKET=### The name of the 'workspace' S3 bucket where Imaging Lab uploads batches of item submissions.
DIGITIZED_THESES_METADATA_API_URL=### The endpoint for the Alma SRU (Search/Retrieve via URL) API, excluding the 'http' scheme.
```
